...
public class TeacherProfilePicUpload extends AppCompatActivity {
    ...
    String ServerUploadPath ="https://rentzhub.co.in/tcs_data/teacherprofilepicupload.php" ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teacher_profile_pic_upload);
        ...
        if (bitmap != null) {
            ...
            class AsyncTaskUploadClass extends AsyncTask<Void, Void, String> {
                ...
                protected void onPreExecute() {
                    ...
                    progressDialog = ProgressDialog.show(TeacherProfilePicUpload.this, "Image is Uploading", "Please Wait", false, false);
                }
                ...
                protected void onPostExecute(String string1) {
                    ...
                    if(string1.equalsIgnoreCase("success")){
                        AlertDialog builder = new AlertDialog.Builder(TeacherProfilePicUpload.this).create();
                        ...
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent intent=new Intent(TeacherProfilePicUpload.this,TeacherMainActivity.class);
                                ActivityOptions options = ActivityOptions.makeCustomAnimation(TeacherProfilePicUpload.this, R.anim.fade_in, R.anim.fade_out);
                ...
                protected String doInBackground(Void... params) {
                    ...
                    HashMapParams.put(empid, employeeid);
