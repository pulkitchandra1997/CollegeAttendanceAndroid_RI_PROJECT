...
public class TeacherMainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void attendanceopen() {
        FrameLayout frameLayout=findViewById(R.id.screen_area);
        fragment=new Attendance(frameLayout,drawer,fab);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            fragment=new TeacherViewStudent();
            flag=1;
        } else if (id == R.id.nav_add_student) {
            fragment=new AddStudent();
            flag=1;
        } else if (id == R.id.nav_view_profile) {
            fragment=new TeacherViewProfile();
            flag=1;
        }
            ...
            fragment=new TeacherEditProfile();
            flag=1;
        }
        fab.setVisibility(View.INVISIBLE);
        getSupportFragmentManager().beginTransaction().replace(R.id.screen_area,fragment).commit();
